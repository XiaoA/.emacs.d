(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/dropbox/org/its-12-2013.org" "~/dropbox/org/itss-11-2013.org" "~/dropbox/org/todo.org" "~/Dropbox/org/its-10-2013.org" "~/Dropbox/org/refile.org" "~/Dropbox/org/its-9-2013.org")))
 '(org-capture-templates (quote (("n" "Note" entry (file "~/Dropbox/org/refile.org") "" :kill-buffer t))))
...
(custom-set-faces
 ...
 '(web-mode-html-tag-bracket-face ((t (:foreground "Snow"))))
 '(web-mode-html-tag-face ((t (:foreground "White"))))
 '(web-mode-inlay-face ((t (:background "controlShadowColor")))))
